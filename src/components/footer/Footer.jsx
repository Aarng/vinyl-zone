...
<footer class="bg-light_red-300 dark:bg-light_red-400">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                          <img src={logo} alt="Vinyl Zone Logo" className="h-32 w-auto" />
                              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">The Vinyl Zone</span>
                          </Link>
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-white">
              <div>
                  <h2 class="mb-6 text-sm font-semibold uppercase dark:text-white text-saffron">Resources</h2>
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold uppercase dark:text-white text-saffron">Follow us</h2>
                  <ul class="font-medium">
                      <li class="mb-4">
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold  uppercase dark:text-white text-saffron">Legal</h2>
                  <ul class="  font-medium">
                      <li class="mb-4">
